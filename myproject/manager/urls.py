...
urlpatterns = [
    ...
    url(r'^panel/manager/deltogroup/(?P<pk>\d+)/(?P<name>.*)/$', views.del_users_to_groups, name='del_users_to_groups'),
    url(r'^panel/manager/perms/$', views.manager_perms, name='manager_perms'),
    url(r'^panel/manager/deltoperms/(?P<name>.*)/$', views.manager_perms_del, name='manager_perms_del'),
    ...
    url(r'^panel/manager/addpermtouser/(?P<pk>\d+)/$', views.users_perms_add, name='users_perms_add'),
    url(r'^panel/manager/groupperm/(?P<name>.*)/$', views.groups_perms, name='groups_perms'),
    url(r'^panel/manager/group/delgroupperm/(?P<gname>.*)/(?P<name>.*)/$', views.groups_perms_del, name='groups_perms_del'),
    url(r'^panel/manager/group/addgroupperm/(?P<gname>.*)/$', views.groups_perms_add, name='groups_perms_add'),
]
